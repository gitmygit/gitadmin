...
export job_item=/${fs}/CodeScan/job_item
export scan_report=/${fs}/CodeScan/report
export scan_log=/${fs}/CodeScan/log/${job_ref_var}
export scan_script_path=/tdadm/bin/CodeScan/CodeScanner


# Export Job Items
#export tac_url='http://sd-ef3e-ee28:8080/org.talend.administrator-6.0.1'
export cmdlin_loc=/${fs}/Talend-Studio-20150908_1633-V6.0.1
...
echo "initRemote $tac_url -ul ${fs}@citi.com -up $passwd" > $build_jobscript
...
cd ${scan_script_path}
#./CodeScanner_run.sh --context_param ItemFile_Name=${job_ref_var} --context_param Email_Receiver=${receiver_email}>> $scan_log.log
